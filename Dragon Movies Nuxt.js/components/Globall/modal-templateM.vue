<template>
<div id="modal-templateM" v-if="getIsModalM" class="modal fade" tabindex="-1" aria-labelledby="modal template" aria-hidden="true">
...
export default {
   data(){
     ...
     computed:{
      ...mapGetters(['getSelected','getLikeBtn','getDislikeBtn','getTotalLike','getTotalDislike','getCheckMyList','getRedirectUrl','getPaths','getMoreItem','getIsModalM']),
       checkTrailer(){
